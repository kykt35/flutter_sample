  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GridView.count(
        ...
        children: [
          for (var index = 0; index < OpenContainerImages.titles.length; index++)
            OpenContainer(
              closedBuilder: (_, openContainer) {
                return GestureDetector(onTap: openContainer, child: ImageItem(url: OpenContainerImages.urls[index]));
              },
